...
Write SD Card
================================================================================================
A simple writable script using 86Duino Zero or 86Duino Educake to display the outcome to Serial 
Monitor.
  
@package   Write SD Card
...
void setup() {
  ...
  if ( configFile ) {
    configFile.println("name=Benjamin Lu");
  // close the file:
    configFile.close();
    Serial.println("done.");
  } else {
